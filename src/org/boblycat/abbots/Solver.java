...
class SolverThread extends Thread {
    ...
    private final List<SearchNode> currentNodes;
    private final Map<SearchKey, SearchNode> searchMap;
    private final Move[] moves;
    private final Position targetPosition;
    private final int targetIndex;
    private final BlockingQueue<ThreadResult> resultQueue;
    private final List<SearchNode> nextNodes;

    public SolverThread(ThreadGroup threadGroup, String threadName, Board board, List<SearchNode> currentNodes,
            Map<SearchKey, SearchNode> searchMap, Move[] moves, Position targetPosition, int targetIndex,
...
public class Solver {
    ...
    private final HashMap<SearchKey, SearchNode> searchMap;
    private final Position targetPosition;
    private final int targetIndex;
    ...
    public String solveMultiThreaded(int numThreads, String movesSep) throws InterruptedException {
        ...
        while (true) {
            ...
            for (int chunkIndex = 0; chunkIndex < currentNodes.size(); chunkIndex += chunksize) {
                ...
                SolverThread thread = new SolverThread(group, "Solver" + actualThreadNum, board, nodesChunk, searchMap,
                        moves, targetPosition, targetIndex, resultQueue);
                thread.start();
                actualThreadNum++;
            }
